...
const Navbar = () => {
  return (
    <>
      <div id="layoutSidenav_nav" style={ { backgroundColor: "#E9ECEF" }}>
        <nav
          className="sb-sidenav accordion navbar"
          id="sidenavAccordion"
        >
          <div className="sb-sidenav-menu">
            <div className="nav ">
              <div className="sb-sidenav-menu-heading text-uppercase">Quản trị</div>
              <Link className="nav-link text-uppercase text-dark" to="/admin/products">
                sản phẩm
              </Link>
              ...
              <div className="sb-sidenav-menu-heading text-uppercase">Thống kê</div>
              <a
